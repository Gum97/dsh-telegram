		...
		*/
		...
		const DICTIONARY = {
			vi: {
				...
				routeApprovalsHint: "Yêu cầu cấp quyền từ phiên Telegram sẽ hiện nút Cho phép / Từ chối trong chat. Tắt thì chúng chỉ hiện ở Web — và nếu bạn không mở trình duyệt, thao tác sẽ bị từ chối.",
			...
			en: {
				...
				routeApprovalsHint: "Permission requests from a Telegram session get Allow / Deny buttons in the chat. Turn this off and they only appear in the Web UI — with no browser open, the action is refused.",
